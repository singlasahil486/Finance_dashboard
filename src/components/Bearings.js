...
const departmentsData = [
  ...
  {
    name: '6200 series HCH',
    imgSrc: process.env.PUBLIC_URL + '/departmentImages/valves.jpg',
  },
  {
    name: '6300 series HCH',
    imgSrc: process.env.PUBLIC_URL + '/departmentImages/valves.jpg',
  },
  {
    name: '6904 LOCAL',
